...
const storeAuthInfo = (authToken, dispatch) => {
    ...
    dispatch(getUserInfo(authToken, decodedToken.user.email))
    saveAuthToken(authToken);
};

export const getUserInfo = (authToken, email) => dispatch => {
    ...
    .then(res => {
        if (res !== 'User Not Found') {
            ...
            console.log(`Could not find information for user: ${email}`)
        }
    })
